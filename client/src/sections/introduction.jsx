                ...
                <div className="flex justify-around items-start w-full mb-10 max-md:flex-col-reverse gap-10" id="introduction">
                    <div className="flex justify-center items-center flex-col w-full ">
                        ...
                        <div className="w-[30ch] text-justify gap-2 flex flex-col mt-5">
                            ...
                            <h3 className="text-md text-black font-montserrat">We will take a look at just how much the winter tick population affects the moose and what needs to change to save the moose.</h3>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center items-center flex-col w-full">
                        ...
                        <div className="w-[30ch] text-justify gap-2 flex flex-col mt-5">
                            ...
                            <h3 className="text-md text-black font-montserrat">The driving factor of the tick population is the winter months, shorter winters means less ticks die off, and vice versa.</h3>
                            <h3 className="text-md text-black font-montserrat">After Data fitting my paramaters I then looked at flipping between long and short winters.</h3>
                            <h3 className="text-md text-black font-montserrat">Keep Scrolling to see these shocking results.</h3>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center items-center flex-col w-full">
                        ...
                        <div className="w-[30ch] text-justify gap-2 flex flex-col mt-5">
                            ...
                            <h3 className="text-md text-black font-montserrat">The moose population is decreasing and it was interesting to create a model that represents this decrease based off of a major factor</h3>
                        </div>
                    </div>
                </div>
        </div>
