    ...
    return (
        <div className="w-full flex flex-col justify-center items-center pb-10" id="results">
            ...
            <div className="flex justify-between items-center w-[80%] mt-20 max-md:flex-col ">
                <div className="flex flex-col justify-center items-start w-full max-md:justify-start max-md:items-center">
                    <ParagraphHeader text="Shorter Winters"/>
                    <p className="w-[45ch] text-black font-montserrat my-3 max-md:text-center max-md:px-20">
